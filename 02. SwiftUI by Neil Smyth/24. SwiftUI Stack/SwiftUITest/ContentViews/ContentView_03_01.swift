//
//  ContentView_03_01.swift
//  SwiftUITest
//
//  Created by mk on 2020/09/29.
//
// 24.3 Alignment Guide Tool
// The SwiftUI Lab
	...
	var body: some View {
		...
		return Form {
			...
			if self.model.addImplicitView {
				...
				Toggle(isOn: self.$model.showImplicit, label: { Text("Show Implicit Guides")})
		...
		VStack(alignment: .leading) {
			...
			if model.addImplicitView {
				...
				VStack(alignment: .leading, spacing: 0) {
					...
					.foregroundColor(self.model.showImplicit ? .secondary :.clear)
