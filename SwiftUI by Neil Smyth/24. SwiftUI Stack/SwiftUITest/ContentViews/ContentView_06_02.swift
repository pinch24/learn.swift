	...
	var body: some View {
		...
		ZStack(alignment: .alignment) {
			...
			Rectangle()
				...
				.alignmentGuide(VerticalAlignment.alignment, computeValue: { d in d[.center] })
...
struct ContentView_06_02_Previews: PreviewProvider {
